...
import org.openrewrite.kotlin.internal.KotlinDeprecatedMethodScanner.DeprecatedMethod;
import org.openrewrite.kotlin.internal.KotlinDeprecatedMethodScanner.ScanResult;
...
import static org.openrewrite.kotlin.internal.KotlinDeprecationRecipeGenerator.*;

class KotlinDeprecationRecipeGeneratorTest {

    @Nested
    class GenerateFromArrowCore {
        @Test
        void generatesValidYaml() throws IOException {
            KotlinDeprecatedMethodScanner scanner = new KotlinDeprecatedMethodScanner();
            ScanResult result = scanner.scan("arrow-core");
            ...
            assertThat(yaml).contains("name: io.arrow-kt.ReplaceDeprecatedArrowCore2Methods");
            assertThat(yaml).contains("org.openrewrite.kotlin.ReplaceDeprecatedKotlinMethod:");
            assertThat(yaml).contains("methodPattern:");
            assertThat(yaml).contains("replacement:");
        }
    }
    ...
    class GenerateYamlRecipe {
        ...
        void generatesCorrectHeader() {
            ...
            assertThat(yaml).startsWith("# Recipes generated for `@Deprecated` methods with `ReplaceWith` in `io.arrow-kt:arrow-core:2.2.1`");
        }

        @Test
        void generatesCorrectRecipeName() {
            ScanResult result = new ScanResult(
                    "io.arrow-kt",
                    "arrow-core",
                    "2.2.1",
        ...
        void generatesCorrectDisplayName() {
            ...
            assertThat(yaml).contains("displayName: Replace deprecated `kotlinx-coroutines-core` methods");
        }
